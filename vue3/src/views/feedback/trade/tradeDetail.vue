              ...
              <div class="item-box">
                <div class="item-title">
                  <a-button
                    type="primary"
                    @click="openInclude()"
                    v-if="hasPermission('VENDOR_FEEDBACK_UPDATE')"
                    >分类</a-button
                  >
                </div>
...
<script lang="ts" setup>
  ...
  import { detailInfo, recordList, include, dealPersonList, dealFeedback } from './trade.api';
  ...
  onMounted(() => {
    getFeedbackInfo();
    if(hasPermission("VENDOR_FEEDBACK_UPDATE")){
      getDealPersonList();
    }
  });
  // 获取处理人list
