      ...
      <div class="update-content-container">
        <div class="table-container">
          <table style="position: relative; width: 100%">
            <thead>
              <tr>
                <th style="min-width: 100px; padding-left: 35px">交易所属店铺名称</th>
                <th style="min-width: 100px">订单编号</th>
                <th style="min-width: 100px">金额 (元)</th>
                <th style="min-width: 100px">创建时间</th>
                <th style="min-width: 100px">买家</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td style="padding-left: 35px">珠海市思捷先行信息技术有限公司</td>
                <td>562657959315954593</td>
                <td>18122.00</td>
                <td>2021-03-02 14:30:06</td>
                <td>cocoyuan</td>
              </tr>
            </tbody>
          </table>
      ...
      <div class="update-content-container flex_between-top" style="padding: 20px 35px">
        <div>
          ...
          <div class="flex_start _item-box">
            <div class="_item-title">微信流水号：</div>
            <div class="_item-value">WX22212020110512452</div>
          </div>
          <div class="flex_start _item-box">
            <div class="_item-title">支付方式：</div>
            <div class="_item-value">XX银行（0056）</div>
          </div>
        </div>

        <div>
          <div class="content-title">支付进度</div>

          <div class="flex_start _item-box">
            <div class="_item-title">下单时间：</div>
            <div class="_item-value">2021-03-02 14:30:00</div>
          </div>
          <div class="flex_start _item-box">
            <div class="_item-title">入账时间：</div>
            <div class="_item-value">2021-03-02 15:31:10</div>
          </div>
        </div>
